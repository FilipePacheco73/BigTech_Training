# -*- coding: utf-8 -*-
"""
Created on Tue Feb 22 08:01:13 2022
...
def getMilestoneDays(revenues, milestones):
  ...
  output = [] # list of days of achievable milestone
  for i in range(len(milestones)):
      aux = True # aux var to check if a milestone was achieved before
      for j in range(len(revenues)):
          if sum(revenues[:j+1]) >= milestones[i] and aux == True:
              output.append(j+1)
              aux = False
